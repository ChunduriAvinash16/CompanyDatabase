...
$start=50*($page-1);
$query1 = "SELECT * FROM cdb WHERE Name_of_the_Company LIKE '$let%' LIMIT ".$start.",10";
?>
<!DOCTYPE html>
<html lang="en">
<head>
